...
if (myfonts_webfont_test)
	document.write('<script type="text/javascript" src="' +path+ '/MyFontsWebfontsOrderM2877476_test.js"></script>');
...
switch (webfontType)
{
		...
		case 'data-css':
		document.write("<link rel='stylesheet' type='text/css' href='" + path + "/webfonts/datacss/MyFontsWebfontsOrderM2877476.css'>");
		break;
	
		case 'svg':
		document.write("<style>\n");
				document.write("@font-face {font-family:\"CoolveticaRg-Regular\";src:url(\"" + path + "/webfonts/svg/style_122838.svg#CoolveticaRg-Regular\") format(\"svg\");}\n");
				document.write("</style>");
		break;
