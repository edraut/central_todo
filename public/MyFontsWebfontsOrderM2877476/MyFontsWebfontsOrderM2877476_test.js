...
woff = path + "/webfonts/woff/style_122838.woff";
if (http) {
...
//test for eot
eot = path + "/webfonts/eot/style_122838.eot";
if (http) {
	xmlhttp=new XMLHttpRequest();
}
else {
...
//test for svg
svg = path + "/webfonts/svg/style_122838.svg";
if (http) {
	xmlhttp=new XMLHttpRequest();
}
else {
...
//test for css
css = path + "/webfonts/datacss/MyFontsWebfontsOrderM2877476.css";
if (http) {
	xmlhttp=new XMLHttpRequest();
}
else {
